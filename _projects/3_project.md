...
This project demonstrates my ability to translate HR data into scalable analytics solutions, combining dashboarding, statistical analysis, and interpretable machine learning to deliver insights that directly support business strategy.
